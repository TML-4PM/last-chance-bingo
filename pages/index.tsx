...
export default function Home() {
  ...
  const handleProductChange = (sku: string, checked: boolean) => {
    setSelectedProducts((prev) => {
      const newSel = { ...prev };
      if (checked) newSel[sku] = quantities[sku] || 1;
      else delete newSel[sku];
      return newSel;
    });
  };
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto p-4 space-y-6">
        ...
        <div className="space-y-2">
          <label htmlFor="email" className="block font-medium">Enter Email to Pre-fill:</label>
          <input
            type="email"
            id="email"
          ...
          />
          <label htmlFor="referralCode" className="block font-medium">Referral Code (optional):</label>
          <input
            type="text"
            id="referralCode"
